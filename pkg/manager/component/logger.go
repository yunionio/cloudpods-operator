...
func (m *loggerManager) getConfigMap(oc *v1alpha1.OnecloudCluster, cfg *v1alpha1.OnecloudClusterConfig, zone string) (*corev1.ConfigMap, error) {
	opt := &options.Options
	...
	return m.newServiceConfigMap(v1alpha1.LoggerComponentType, zone, oc, opt), nil
}
