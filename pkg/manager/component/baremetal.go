...
func (m *baremetalManager) getConfigMap(
	oc *v1alpha1.OnecloudCluster, cfg *v1alpha1.OnecloudClusterConfig, zone string,
	...
	opt.Zone = zoneId
	return m.newServiceConfigMap(v1alpha1.BaremetalAgentComponentType, zone, oc, opt), nil
}
